 ...
 */
final class Version20240117141940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD author_id INT NOT NULL, CHANGE rating rating INT NOT NULL, CHANGE nbr_of_response nbr_of_response INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question DROP author_id, CHANGE rating rating TINYINT(1) NOT NULL, CHANGE nbr_of_response nbr_of_response TINYINT(1) NOT NULL');
    }
}
